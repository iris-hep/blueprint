...
There were 10 presentations delivered to trigger discussion on the main themes and objectives of the workshop:

\vspace{0.1cm}

\noindent~~~$\bullet$~\textbf{\textit{IRIS-HEP Blueprint Concepts and Process}} (Mark Neubauer / Illinois)

\noindent~~~$\bullet$~\textbf{\textit{Scalable Systems Laboratory: Challenges, \& Opportunities}} (Rob Gardner / Chicago)

\noindent~~~$\bullet$~\textbf{\textit{Analysis Systems Perspectives \& Goals}} (Kyle Cranmer / NYU)

\noindent~~~$\bullet$~\textbf{\textit{SSL Hybrid Models, Developer Support \& Deployments}} (Lincoln Bryant / Chicago)

\noindent~~~$\bullet$~\textbf{\textit{Use of the Google Cloud Platform in High-Energy Physics}} (Lukas Heinrich / CERN)

\noindent~~~$\bullet$~\textbf{\textit{RedHat OpenShift}} (Sanjay Arora / RedHat)

\noindent~~~$\bullet$~\textbf{\textit{Google Perspective}} (Stephan Fang / Google)

\noindent~~~$\bullet$~\textbf{\textit{Research Computing Technology at NYU}} (David Ackerman / NYU)

\noindent~~~$\bullet$~\textbf{\textit{Accelerated Systems \& Optimization}} (Andrew Chien / Chicago)

\noindent~~~$\bullet$~\textbf{\textit{ServiceX Architecture \& Status}} (Ben Galewsky / Illinois) \\
...
Robert Gardner (UChicago) presented {\it Scalable Systems Laboratory (IRIS-HEP) - challenges, opportunities}.
\begin{wrapfigure}[21]{R}{0.48\textwidth}
  \includegraphics[width=0.99\linewidth]{figures/rwg_ssl.jpg}
  \caption{Rob Gardner presents the Scalable Systems concept on Day 1 of the workshop.}
  \label{fig:rwg_ssl}
\end{wrapfigure}
The initial program of work of the SSL activity was described.  Given the SSL core has less than one FTE of effort, success will depend on leveraged efforts from other areas of IRIS-HEP and engaged partners. The high level purpose of the SSL is to provide the Institute and the HL-LHC experiments with scalable platforms needed for development in context, i.e. the {\it path to production}. The SSL:
...
%\begin{wrapfigure}[21]{R}{0.48\textwidth}
\begin{figure}
  \includegraphics[width=0.69\linewidth]{figures/galewsky_servicex.jpg}
  \caption{Ben Galewsky presents on the ServiceX system on Day 2 of the workshop.}
