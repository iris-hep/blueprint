...
There were 10 presentations chosen to trigger discussion on the main themes and objectives of the workshop.

\vspace{0.1cm}

\noindent~~$\bullet$~\textbf{\textit{IRIS-HEP Blueprint Concepts and Process}} (Mark Neubauer)

\noindent~~~$\bullet$~\textbf{\textit{Scalable Systems Laboratory (IRIS-HEP) - challenges, opportunities}} (Rob Gardner)

\noindent~~~$\bullet$~\textbf{\textit{Analysis Systems Perspectives \& Goals}} (Kyle Cranmer)

\noindent~~~$\bullet$~\textbf{\textit{SSL patterns: hybrid models, developer support, deployments}} (Lincoln Bryant)

\noindent~~~$\bullet$~\textbf{\textit{HEP Use of the Google Cloud Platform}} (Lukas Heinrich)

\noindent~~~$\bullet$~\textbf{\textit{RedHat OpenShift}} (Sanjay Arora)

\noindent~~~$\bullet$~\textbf{\textit{Google Perspective}} (Stephan Fang)

\noindent~~~$\bullet$~\textbf{\textit{Research Computing Technology at NYU}} (David Ackerman)

\noindent~~~$\bullet$~\textbf{\textit{Accelerated Systems and Optimization}} (Andrew Chien)

\noindent~~~$\bullet$~\textbf{\textit{ServiceX Architure}} (Ben Galewsky).
